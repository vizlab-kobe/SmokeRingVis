# InSituVis.mpi.CameraPath

This MPI application visualizes the SmokeRing simulation with camera path
control.

## Placement

```sh
SmokeRingVis/App/InSituVis.mpi.CameraPath/
```

The binary name is `InSituVis.mpi.CameraPath` because `kvsmake -G` uses the
