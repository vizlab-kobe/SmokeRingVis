...
auto LightEnt = InSituVis::mpi::CameraPathTimeStepControlledAdaptor::LightnessEntropy();
auto DepthEnt = InSituVis::mpi::CameraPathTimeStepControlledAdaptor::DepthEntropy();
auto MixedEnt = InSituVis::mpi::CameraPathTimeStepControlledAdaptor::MixedEntropy( LightEnt, DepthEnt, MixedRatio );
...
// Path interpolator
const auto InterpolationMethod = InSituVis::mpi::CameraPathTimeStepControlledAdaptor::InterpolationMethod::SLERP;
// const auto InterpolationMethod = ::Adaptor::InterpolationMethod::SQUAD;

} // end of namespace Params

// Adaptor
using AdaptorBase = InSituVis::mpi::CameraPathTimeStepControlledAdaptor;
...
Adaptor* InSituVis_new( const int method )
{
    ...
    vis->setOutputDivergenceEnabled ( Params::Output::Divergence );
