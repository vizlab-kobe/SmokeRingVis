# InSituVis.mpi.TimeStep

This MPI application visualizes the SmokeRing simulation with time-step control.

## Placement

```sh
SmokeRingVis/App/InSituVis.mpi.TimeStep/
```

The binary name is `InSituVis.mpi.TimeStep` because `kvsmake -G` uses the
